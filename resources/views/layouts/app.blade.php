            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-10 sm:mb-14">
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="https://wa.me/6281253816878" class="footer-social-btn" title="WhatsApp">
                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start gap-3">
                          ...
                          <span style="color:rgba(0,0,0,.5);font-size:13px;line-height:1.6;">
                            ...
                            <span style="display:block;">1. BSCC Dome, Balikpapan</span>
                            <span style="display:block;">2. Hevindo Arena, Balikpapan</span>
                            <span style="display:block;">3. GOR Bulutangkis BJBJ, Balikpapan</span>
                        </span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="mt-0.5 flex-shrink-0" style="color:#f97316;">
