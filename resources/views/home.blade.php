    ...
    <div id="cs-scroll">
        ...
        <img src="https://res.cloudinary.com/djs5pi7ev/image/upload/v1773109896/LOGO_BO2026_pzbvxh.png" alt="Bayan Open 2026" class="cs-logo" id="cs-logo">
            ...
            <div class="cs-notify" id="cs-notify">
                <a href="mailto:bayan.open@gmail.com?subject=Kapan%20pendaftarannya%20dimulai&body=Halo%2C%20saya%20ingin%20menanyakan%20kapan%20pendaftaran%20akan%20dimulai.%20Terima%20kasih." target="_blank" class="btn-fire">
                   Beri Tahu Saya
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 01-3.46 0"/></svg>
                </a>
