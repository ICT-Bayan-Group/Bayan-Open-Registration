...
<section class="min-h-screen py-20 px-6 flex items-center justify-center">
    <div class="max-w-lg w-full">
        ...
        {{-- Success Message --}}
        @if (session('success'))
        <div class="bg-green-500/10 border border-green-500/30 rounded-xl p-4 mb-6 mx-auto max-w-lg">
        ...
        <div class="card-glass rounded-2xl p-8 text-center">
            ...
            <div class="mt-8 space-y-3">
                <a href="{{ route('home') }}"class="inline-flex items-center gap-2 text-white/40 text-sm hover:text-white/70 transition">
