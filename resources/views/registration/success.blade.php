...
<section class="min-h-screen flex items-center justify-center py-20 px-6">
    <div class="max-w-md w-full text-center">
        <div class="card-glass rounded-2xl p-10">
            ...
            <p class="text-white/60 text-sm mb-6">Terima kasih telah mendaftar Bayan Open 2026. Receipt PDF akan dikirim ke email Anda.</p>
            ...
            <a href="{{ url('/') }}" class="block border border-white/20 py-3 rounded-xl text-sm text-white/70 hover:text-white transition">
                Kembali ke Beranda
            </a>
        </div>
    </div>
